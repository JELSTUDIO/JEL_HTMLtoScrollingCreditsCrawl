# JEL_HTMLtoScrollingCreditsCrawl_v1.0.0
...
def encode_video(frames_dir, audio_path, output, fps, crf, preset, codec, gpu):
...
class App:
    def __init__(self, root):
        self.root = root
        root.title("JELSTUDIO HTMLtoScrollingCreditsCrawl v1.0.0")
